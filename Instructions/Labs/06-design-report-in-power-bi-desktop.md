...
1. 從 [ **資料]** 窗格中，將 [ **產品 \| 類別]** 欄位拖曳至 **[此頁面上的篩選** ] 區/區域。
...
1. 將游標停留在其中一個視覺效果上方，然後在右上方選取省略號 (...) ，然後注意功能表選項。 請嘗試 [在 Teams 中聊天] 以外的每個選項。
...
1. 請注意，[Region] 交叉分析篩選器在 [概觀] 頁面的 [Region] 交叉分析篩選器上有不同選擇。
    ...
    *交叉分析篩選器不會同步處理。您將修改報告設計，以確保它們在**Power BI Desktop 實驗室中的增強報表**頁面之間同步處理。*
 ...
 *您將使用在**Power BI Desktop 實驗室中增強報表**中的進階功能來增強報表設計。*
