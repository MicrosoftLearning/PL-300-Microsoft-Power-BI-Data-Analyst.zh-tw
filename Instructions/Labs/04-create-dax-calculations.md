...
1. 複選量值時，請設定下列需求：
    ...
    - 將格式設定為小數位後兩位。
    - 指派給名為_Pricing_ 的顯示資料夾 （使用 **[屬性]**** 窗格中的 [顯示資料夾**] 屬性）。
...
1. 將資料`Targets | Target` 行重新命名為_TargetAmount_。
