...
1. 建立新頁面並將其重新命名為_Product Details_。
...
在本練習中，您將使用按鈕增強 [我的效能 _]_ 頁面，讓報表使用者選取要顯示的視覺效果類型。 當您完成設計時，此頁面會如下所示：
...
1. 建立第二個書籤，並適當地命名它 （_直條圖開啟_ 或_長條圖開啟_。
...
1. 若要探索報表，請選取_09-Starter-Sales Analysis_ 報表。
