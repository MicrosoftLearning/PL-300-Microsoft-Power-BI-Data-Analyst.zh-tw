...
1. 在 [ **開啟]** 視窗中，流覽至 **D：\Allfiles\Labs\07-design-report-in-power-bi-desktop-enhanced\Starter** 資料夾，然後開啟 **Sales Analysis** 檔案。
...
在這項工作中，您將新增兩個書籤，一個用來顯示每個每月銷售/目標視覺效果。
...
*您將在下一個練習中探索 Power BI 服務 中的報表。*

## **探索報表**

在這項工作中，您將探索 Power BI 服務 中的報表。
