...
將資料夾解壓縮到 **C：\Users\Student\Downloads\09-create-dashboard** 資料夾。
...
1. 流覽至 **C：\Users\Student\Downloads\09-create-dashboard** 資料夾。

1. **選取 09-Starter-Sales Analysis.pbix** 檔案，然後選取 [**開啟**]。
...
1. 在 Power BI 服務 中，開啟 **09-Starter-Sales Analysis** 報表。
...
1. 在 [**新增影像磚**] 窗格的 **[URL**] 方塊中，輸入 C：\Users\Student\Downloads\09-create-dashboard\AdventureWorksLogo_DataURL.txt** 檔案中找到**的完整 URL，然後套**用**。
...
> ***注意**：如果您無法連線到資料庫，您可以使用 **09-Solution-Sales-Analysis.pbix** 檔案。 不要更新資料庫並重新整理語意模型，而是將方案檔上傳至 **[我的工作區** ]，並查看下列工作中參考的變更。*

## **更新實驗室資料庫**

在此工作中，您將執行 PowerShell 指令碼，以更新 **AdventureWorksDW2020** 資料庫中的資料。

1. 在 檔案總管 中，於 C：\Users\Student\Downloads\09-create-dashboard 資料夾內 **，以滑鼠右鍵單擊 **UpdateDatabase-2-AddSales.ps1** 檔案，然後選取 [**使用 PowerShell** 執行]。**
...
在這項工作中，您將開啟 **09-Starter-Sales Analysis** Power BI Desktop 檔案、執行數據重新整理，然後將檔案上傳至您的 **Sales Analysis** 工作區。
